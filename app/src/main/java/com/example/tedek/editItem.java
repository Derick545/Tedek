...
public class editItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setOnClickListener for addImage
        ...
        //setOnclickListener for updateBtn
        updateBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //calling method updateInformation()
                updateInformation();
            }
        });
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(editItem.this, ViewItems.class);
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                ...
                                                handler.postDelayed(new Runnable() {
                                                    @Override
                                                    public void run() {
                                                        Toast.makeText(editItem.this, "Item Created Successfully", Toast.LENGTH_SHORT).show();
                                                    }
                                                }, 5000);
